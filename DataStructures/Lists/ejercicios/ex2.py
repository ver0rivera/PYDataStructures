...
# like the following line: From stephen.marquard@uct.ac.za
# Sat Jan 5 09:14:16 2008 You will parse the From line using split()
...
count = 0
for line in fh:
    toRstrip = line.rstrip()
    ToSplit = toRstrip.split()
    if 'From' in ToSplit:
        print(ToSplit[1])
        count += 1
    else:
